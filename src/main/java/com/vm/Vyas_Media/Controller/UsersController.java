...
import com.vm.Vyas_Media.Enum.UserConstant;
...
public class UsersController {
    ...
    //If loggedin user is ADMIN -> ADMIN OR EMPLOYEE
    //If loggedin user is EMPLOYEE -> EMPLOYEE
    ...
    public String testUserAccess() {
        return "user and employee can only access this !";
    }
    ...
    private List<String> getRolesByLoggedInUser(Principal principal) {
        ...
        if (assignRoles.contains("ROLE_EMPLOYEE")) {
            return Arrays.stream(UserConstant.EMPLOYEE_ACCESS).collect(Collectors.toList());
        }
